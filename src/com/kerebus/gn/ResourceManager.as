package com.kerebus.gn
{
	...
	{
		[Embed(source="../media/ninja.png")]
		public static var NinjaID1:Class;
		public static var NinjaGraphics : GraphicsResource = new GraphicsResource(new NinjaID1(), 3, 20);
		
		[Embed(source="../media/shuriken_small.png")]
		public static var ShurikenID1:Class;
		public static var ShurikenGraphics : GraphicsResource = new GraphicsResource(new ShurikenID1(), 4, 20);
		...
		[Embed(source="../media/wayofninja.mp3")]
